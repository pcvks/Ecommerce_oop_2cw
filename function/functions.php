...
function cart(){
    ...
    if(isset($_GET['add_cart'])){
        ...
        $ip = get_ip();
        $run_check_pro = mysqli_query($con, "select * from
         ...
         if(mysqli_num_rows($run_check_pro) > 0){
             ...
             $run_insert_pro = mysqli_query($con, "insert into cart (product_id,
             product_title,ip_address) 
             value ('$product_id','$pro_title','$ip') ");
