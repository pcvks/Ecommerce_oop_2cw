...
<div class="border_bottom">
    ...
    <div class="search_bar">
        ...
        <table width="100%">
            ...
            <?php $all_categories = mysqli_query($con,"select * from brands order by brand_id DESC"); 
            $i = 1;
            ...
            <tbody>
                <tr>
                    ...
                    <td><a style="background:green; width:35px; border-radius:5px; height:25px; color:white; text-decoration:none;" href="index.php?action=edit_brand&brand_id =<?php echo $row['brand_id'];?>">Edit</a></td>
                    <td><a style="background:red; width:35px; border-radius:5px; height:25px; color:white; text-decoration:none;" href="index.php?action=view_brand&delete_brand =<?php echo $row['brand_id'];?>"> Delete</a></td>
...
if(isset($_POST['delete_brand'])){
    $delete_brand = mysqli_query($con,"DELETE FROM `brands` WHERE brand_id = '$_POST[delete_brand]' ");
    if($delete_brand){
